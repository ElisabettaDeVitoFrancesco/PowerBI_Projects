# Adventure Works Report Project
...
To see an overview of the report, please have a look at the pdf file AdventureWorks_Report, in case the PowerBI file won't work properly.
